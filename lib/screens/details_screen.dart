...
import 'package:malontest/model/movie_details.dart';
...
import 'package:malontest/utils/star_calculator.dart'
    as starCalculator;
import 'package:malontest/utils/file_manager.dart' as file;
import 'package:malontest/utils/toast_alert.dart' as alert;

//Detail screen that showcase the details of the movies after the user clicks on a particular movie.
...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  //function to save favourite when user likes a movies and it prompt them that it has been added to their Favourite
  saveFavorite() async {
...
//This function removes movies from Favourite
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 1.h),
                          //listing of generes of the movie
                          Padding(
                            padding: EdgeInsets.symmetric(horizontal: 4.h),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                //Ooverview/Description of the movie
                                Expanded(
                                  child: Padding(
                                    padding: EdgeInsets.only(
                                        right: 1.h,
